        ...
        <div className="flex flex-col gap-1.5">
            ...
            <Dropdown open={openCountryCodePanel && !disabled}>
                <Dropdown.Button>
                    ...
                    >
                        <div
                            className={`h-10 grow shrink pl-3 py-2 flex items-center gap-2`}
                        >
                            <Typography
                                color={
                                    value && !disabled ? "gray-900" : "gray-500"
                                }
                                className="whitespace-nowrap"
                            >
                                {
                                    currencyToSymbolsMap[
                                        selectedCurrencyCode as keyof typeof currencyToSymbolsMap
                                    ]
                                }
                            </Typography>
                        ...
                        <div
                            ...
                            onClick={() =>
                                setOpenCountryCodePanel(prev => !prev)
                            }
                        >
                            <Typography
                                ...
                                >
                                    <div className="grow">
                                        <Typography size="sm" color="gray-900">
                                            ...
                                            {
                                                currencyToSymbolsMap[
                                                    currencyCode as keyof typeof currencyToSymbolsMap
                                                ]
                                            }
                                        </Typography>
                                    </div>
