...
export const PhoneInputField: FC<PhoneInputProps> = ({
    ...
    return (
        <div className="flex flex-col gap-1.5">
            ...
            <Dropdown
                fullWidth={fullWidth}
                open={openCountryCodePanel && !disabled}
            >
                <Dropdown.Button>
                    <div
                        className={clsx(
                    ...
                    >
                        ...
                        <div
                            className={`h-10 grow shrink pr-3 py-2 flex items-center gap-2`}
                        >
                            <Typography
                                color={
                ...
                <Dropdown.Panel>
                    ...
                    >
                        {countryCodes.map(({ code, iso2, name }) => {
                            return (
                                <div
